...
class OutOfBoundaryPaths:
    ...
    def solve_recursive(self, num_rows: int, num_cols: int, max_moves: int, start_row: int, start_col: int) -> int:
    ...
    def solve_memo(self, num_rows: int, num_cols: int, max_moves: int, start_row: int, start_col: int,
                   cache: Dict) -> int:
