...
from leetcode.p_1481_least_num_unique_after_k_removals import FindLeastNumOfUniqueAfterRemoval


@pytest.mark.parametrize("test_input_arr, test_input_k, expected", [
    ([5, 5, 4], 1, 1),
    ([4, 3, 1, 1, 3, 3, 2], 3, 2),
    ([2, 4, 1, 8, 3, 5, 1, 3], 3, 3),
])
