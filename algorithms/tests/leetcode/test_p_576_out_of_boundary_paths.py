...
from leetcode.p_1457_pseudopalindromic_paths import PseudoPalindromicPaths_recursive, PseudoPalindromicPaths_iterative, \
    TreeNode
from leetcode.p_576_out_of_boundary_paths import OutOfBoundaryPaths


@pytest.mark.parametrize("m, n, max_moves, start_row, start_col, expected",
                         [
                             (2, 2, 0, 0, 0, 0),
                             (2, 2, 1, 0, 0, 2),
                             (2, 2, 2, 0, 0, 6),
