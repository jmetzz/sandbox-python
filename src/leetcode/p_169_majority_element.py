...
if __name__ == "__main__":
    input_arr = [3, 2, 3]
    print(majority_element_solve_counter(input_arr))  # 3
    print(majority_element_solve_heap(input_arr))  # 3
    print(majority_element_solve_boyer_moore_majority_alg(input_arr))  # 3
