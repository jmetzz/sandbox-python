...
LOGGING_CONFIG = {
    ...
    "formatters": {
        ...
        "json": {"()": "ce.utils.CustomJsonFormatter"},
    },
    "handlers": {"main": {"class": "logging.StreamHandler", "formatter": "json", "stream": sys.stdout}},
    "loggers": {"root": {"level": "INFO", "propagate": True, "handlers": ["main"]},},
}
