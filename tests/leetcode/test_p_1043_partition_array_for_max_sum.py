...
def test_solve_dfs_list_memo(test_input_arr, test_input_k, expected):
    assert (
        PartitionArrayForMaxSum().solve_dfs_list_memo(test_input_arr, test_input_k)
        == expected
    )
...
def test_solve_dfs_dict_memo(test_input_arr, test_input_k, expected):
    assert (
        PartitionArrayForMaxSum().solve_dfs_dict_memo(test_input_arr, test_input_k)
        == expected
    )
...
def test_solve_tabulation_top_down(test_input_arr, test_input_k, expected):
    assert (
        PartitionArrayForMaxSum().solve_tabulation_top_down(
...
def test_solve_tabulation_top_down_circular_list(
    test_input_arr, test_input_k, expected
):
    assert (
        PartitionArrayForMaxSum().solve_tabulation_top_down_circular_list(
            test_input_arr, test_input_k
        )
        == expected
    )
